                ...
                <div class="selectors-up">
                    <div class="select__sizes">
                        ...
                        <div class="sizes">
                            ...
                            >
                                <Checkbox
                                @selectedValue="handleSizeCheckboxes"
                                :pizzaSizes="pizzaSizes"
                                :value="item" :labelValue="`${item} см.`" />
                            </div>
                        </div>
                    </div>
                    <div class="select__types">
                        ...
                        <div class="types">
                            <Checkbox 
                                @selectedValue="handleTypeCheckboxes"
...
export default {
    ...
    setup() {
        ...
        const handleTypeCheckboxes = (value) => {
            if(pizzaType.value.includes(value)) {
                pizzaType.value = pizzaType.value.filter(labelValue => labelValue !== value)
                return
            }
            pizzaType.value.push(value)
            pizzaType.value.sort()
            console.log(pizzaType.value)
        }

        const priceItems = [{size: 26, price: 345},{size: 30, price: 455},{size: 40, price: 620},]
